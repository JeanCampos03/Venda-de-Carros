...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/escalade.jpg');" data-stellar-background-ratio="0.5">
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">camposjean4@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
        </div>
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="https://github.com/JeanCampos03?tab=repositories" class="py-2 d-block">GitHub</a></li>
              </ul>
            </div>
          </div>     
          <div class="col-md">
